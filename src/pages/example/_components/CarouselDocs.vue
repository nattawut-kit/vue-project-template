...
<script setup lang="ts">
  ...
  const propsTable: DocRow[] = [
    ...
    },
    {
      ...
      default: 'false',
      description:
        'true = ลาก/ปัดเลยใบสุดท้ายแล้ววนไปใบแรกต่อได้เรื่อยๆ (ใบแรกลากย้อนก็ไปใบสุดท้าย) ไม่มีแรงหน่วง, false = ไปตามลำดับ สุดที่ใบแรก/ใบสุดท้าย ต้องลากย้อนกลับเท่านั้น — มีผลกับการลาก/ปัดเท่านั้น autoplay ยังวนต่อเสมอ',
    },
    {
      name: 'dragFollow',
      type: 'boolean',
